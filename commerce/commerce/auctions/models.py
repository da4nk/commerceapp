...
class Comments(models.Model):
    ...
    closed_auction = models.ForeignKey(closed_listings, on_delete=models.CASCADE, related_name="old_listing")


    def __str__(self):
        return f"comment id: {self.pk},  content: {self.content}, date comment was made: {self.date}, auction comment was made on:{self.auction}"
